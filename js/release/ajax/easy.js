...
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__23418,G__23419) : ajax.easy.keyword_response_format_element.call(null,G__23418,G__23419));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
return ajax.easy.keyword_response_format_element(p1__23422_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__23423){
...
return (function ajax$easy$transform_handler_$_easy_handler(p__23426){
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__23432){
